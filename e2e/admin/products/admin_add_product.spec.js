...
describe('Admin Add Product Page View', function() {
  describe( "Add Product", function() {
    beforeEach(function() {
      ...
      this._add_product_page.visit_by_clicking_add_product();
  ...
  describe("Edit Product", function() {
    beforeEach(function() {
      this._add_product_page = require('./admin_add_product.po.js');
      this._add_product_page.visit_by_click_product(0);
    });
    ...
    iit('product details should be populated correctly', function() {
      ...
      // should contain Title field
      expect(this._add_product_page.titleFieldEl.isDisplayed()).toBe(true);
      expect(this._add_product_page.titleFieldEl.getAttribute('value')).toBe("Product 1");

      // should contain Description field
      expect(this._add_product_page.descriptionFieldEl.isDisplayed()).toBe(true);
      expect(this._add_product_page.descriptionFieldEl.getAttribute('value')).toBe("Product Description 1");

      // should contain Page Title field
      expect(this._add_product_page.pageTitleFieldEl.isDisplayed()).toBe(true);
      expect(this._add_product_page.pageTitleFieldEl.getAttribute('value')).toBe("Product Page Title 1");

      // should contain Meta Description field
      expect(this._add_product_page.metaDescriptionFieldEl.isDisplayed()).toBe(true);
      expect(this._add_product_page.metaDescriptionFieldEl.getAttribute('value')).toBe("Product Meta Description 1");
